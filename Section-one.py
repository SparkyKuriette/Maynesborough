...
print("(Press enter to continue)")
input()
print("\"Huh... Well, let's move to Naybridge-\" said Alfo; Teiya interrupted \"because I hear there's a competition!\" Alfo and Teiya travelled to Naybridge Markpoint, while Jakka travelled to Mayscore Markpoint.")
print("\"The Markpoints are located in the centre of the community and the towns and cities are built around the Markpoints,\" the country guides stated, \"and they were built long ago in specific spots; these were so that the monarchs and their mappers would easily map the entire land out, and that regions could be marked and data easily gathered. In order to build a new settlement, and therefore a new Markpoint, people have to get permission from the Government.\"")
